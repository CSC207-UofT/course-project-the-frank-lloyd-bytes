 ...
 * This class is a collection of commands which give the funcytionality  to the menu class
 ...
 *
 * For the first iteration we will simply have commands to check if user already exists, and check password.
 */
