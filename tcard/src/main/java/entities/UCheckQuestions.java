...
public class UCheckQuestions {
    ...
    public static List<Question> getQuestions() {
        ...
        questionList.add(new Question("Do any of the following statements apply to you?","\u2022 I am fully vaccinated against COVID-19.\n\n" +
        ...
        questionList.add(new Question("Do any of the following statements apply to you?","Any/all that are new, worsening, and not related to other known causes or conditions you already have.\n\n" +
        ...
        questionList.add(new Question("Is anyone you live with currently experiencing any new COVID-19 symptoms and/or waiting for test results after experiencing symptoms?", "If you are fully vaccinated (it has been 14 or more days since your final dose of either a two-dose or a one-dose vaccine series), select “No.”\n\n" +
        ...
        questionList.add(new Question("In the last 14 days, have you travelled outside of Canada and been told to quarantine (per the federal quarantine requirements)?", "Note: if you have travelled but have received an exemption from the travel quarantine requirements (eg. fully vaccinated etc.), click No."));
        questionList.add(new Question("Has a doctor, health care provider, or public health unit told you that you should currently be isolating (staying at home)?","This can be because of an outbreak or contact tracing."));
        questionList.add(new Question("In the last 10 days, have you been identified as a \"close contact\" of someone who currently has COVID-19?","“Close contact” as determined or identified by a public health authority or the University of Toronto Occupational Health Nurse.\n\n" +
        ...
        questionList.add(new Question("In the last 14 days, have you received a COVID Alert exposure notification on your cell phone?","If you are fully vaccinated (it has been 14 or more days since your final dose of either a two-dose or a one-dose vaccine series), select “No.”\n\n" +
                "If you already went for a test and got a negative result, select “No.”"));
        questionList.add(new Question("In the last 10 days, have you tested positive on a rapid antigen test or home-based self-testing kit?","If you have since tested negative on a lab-based PCR test, select “No.\""));
        return questionList;
    }
}
